 ...
 */
/* RGBA8 builds an int, and one with the top alpha bit set is negative, which
 * a braced initialiser refuses to narrow into an unsigned field.  The colour
 * is a bit pattern rather than a number, so the cast says so once here
 * instead of fourteen times below. */
#define TH_RGBA(r, g, b, a) ((unsigned int)RGBA8(r, g, b, a))

static const ThemePalette kDarkPalette = {
    TH_RGBA(0x0E, 0x10, 0x16, 0xFF),   /* bg          */
    TH_RGBA(0x1A, 0x1D, 0x26, 0xFF),   /* surface     */
    TH_RGBA(0x26, 0x2B, 0x38, 0xFF),   /* surface_hi  */
    TH_RGBA(0x33, 0x39, 0x48, 0xFF),   /* line        */
    TH_RGBA(0x4C, 0x8D, 0xFF, 0xFF),   /* accent      */
    TH_RGBA(0x4C, 0x8D, 0xFF, 0x33),   /* accent_soft */
    TH_RGBA(0xEC, 0xEF, 0xF4, 0xFF),   /* text        */
    TH_RGBA(0x93, 0x9D, 0xB0, 0xFF),   /* text_dim    */
    TH_RGBA(0x5E, 0x67, 0x78, 0xFF),   /* text_faint  */
    TH_RGBA(0x00, 0x00, 0x00, 0x40),   /* shadow_1    */
    TH_RGBA(0x00, 0x00, 0x00, 0x22),   /* shadow_2    */
    TH_RGBA(0x00, 0x00, 0x00, 0xB0),   /* scrim       */
    TH_RGBA(0x0E, 0x10, 0x16, 0xD8),   /* caption     */
    TH_RGBA(0xE5, 0x6B, 0x6F, 0xFF)    /* danger      */
};

static const ThemePalette kLightPalette = {
    TH_RGBA(0xF4, 0xF5, 0xF8, 0xFF),   /* bg          */
    TH_RGBA(0xFF, 0xFF, 0xFF, 0xFF),   /* surface     */
    TH_RGBA(0xE8, 0xEB, 0xF2, 0xFF),   /* surface_hi  */
    TH_RGBA(0xD2, 0xD7, 0xE1, 0xFF),   /* line        */
    TH_RGBA(0x1F, 0x6F, 0xE5, 0xFF),   /* accent      */
    TH_RGBA(0x1F, 0x6F, 0xE5, 0x28),   /* accent_soft */
    TH_RGBA(0x14, 0x17, 0x1F, 0xFF),   /* text        */
    TH_RGBA(0x53, 0x5C, 0x6D, 0xFF),   /* text_dim    */
    TH_RGBA(0x8A, 0x93, 0xA3, 0xFF),   /* text_faint  */
    TH_RGBA(0x1B, 0x20, 0x2C, 0x1C),   /* shadow_1    */
    TH_RGBA(0x1B, 0x20, 0x2C, 0x0E),   /* shadow_2    */
    TH_RGBA(0x22, 0x26, 0x30, 0x80),   /* scrim       */
    TH_RGBA(0xFF, 0xFF, 0xFF, 0xD8),   /* caption     */
    TH_RGBA(0xC0, 0x39, 0x3D, 0xFF)    /* danger      */
};
